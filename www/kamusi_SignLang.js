...
function run() {
	...
	//$.get("https://kamusigold.org"+input_word+"/"+src_lang+"/"+trgt_lang
...
function displayResults(data, input_word, src_lang, trgt_lang, dumpTarget, displayEnglish, trgt_lang_word, src_lang_word){
	...
	if(trgt_lang =='hds' || trgt_lang =='nps'){
		...
		if(serverWords[i].src_definition !=""){
			var singleInfoDiv = document.createElement("div");
			singleInfoDiv.setAttribute('class','singleInfoDiv w3-container');
			var t = document.createTextNode("Definition: "+serverWords[i].src_definition);
			singleInfoDiv.appendChild(t);
			sourceInfo.appendChild(singleInfoDiv);
		}
		...
		if(serverWords[i].src_gloss !=""){
			var singleInfoDiv = document.createElement("div");
			singleInfoDiv.setAttribute('class','singleInfoDiv w3-container');
			var t = document.createTextNode("Definition: "+serverWords[i].src_gloss);
			singleInfoDiv.appendChild(t);
			sourceInfo.appendChild(singleInfoDiv);
		}
		...
		var termsDump = document.createElement('div');
			...
			if(serverWords[i].english_definition !=""){
				var singleInfoDiv = document.createElement("div");
				singleInfoDiv.setAttribute('class','singleInfoDiv w3-container');
				var t = document.createTextNode("Definition: "+serverWords[i].english_definition);
				singleInfoDiv.appendChild(t);
			...
			if(serverWords[i].english_example_sents !=""){
				var singleInfoDiv = document.createElement("div");
				singleInfoDiv.setAttribute('class','singleInfoDiv w3-container');
				var t = document.createTextNode("Context Example: "+serverWords[i].english_example_sents);
				singleInfoDiv.appendChild(t);
				englishInfo.appendChild(singleInfoDiv);
			}
		...
		var termsDump = document.createElement('div');
			...
			if(serverWords[i].dest_concept){
				...
				if(serverWords[i].dest_definition !=""){
					var singleInfoDiv = document.createElement("div");
					singleInfoDiv.setAttribute('class','singleInfoDiv w3-container');
					var t = document.createTextNode("Definition: "+serverWords[i].dest_definition);
					singleInfoDiv.appendChild(t);
					targetInfo.appendChild(singleInfoDiv);
				}
				...
				if(serverWords[i].dest_example_sents !=""){
					var singleInfoDiv = document.createElement("div");
					singleInfoDiv.setAttribute('class','singleInfoDiv w3-container');
					var t = document.createTextNode("Context Example: "+serverWords[i].dest_example_sents);
					singleInfoDiv.appendChild(t);
					targetInfo.appendChild(singleInfoDiv);
				}
				...
				if(serverWords[i].dest_gloss !=""){
					var singleInfoDiv = document.createElement("div");
					singleInfoDiv.setAttribute('class','singleInfoDiv w3-container');
					var t = document.createTextNode("Definition: "+serverWords[i].dest_gloss);
					singleInfoDiv.appendChild(t);
					targetInfo.appendChild(singleInfoDiv);
				}
			}
			...
			var termsDump = document.createElement('div');
			termsDump.className ="w3-container termsDump";

			var singleTermDiv = document.createElement("div");
			singleTermDiv.setAttribute('class','no-term w3-container');

			var t = document.createTextNode("Upcoming Feature: Suggest a Term");
			singleTermDiv.appendChild(t);
			termsDump.appendChild(singleTermDiv);
				...
				var singleInfoDiv = document.createElement("div");
				singleInfoDiv.setAttribute('class','noInfo w3-container');
				var t = document.createTextNode("No matches yet. Registered speakers of "+serverWords[i].dest_language+" please input your suggestion.");
				singleInfoDiv.appendChild(t);
	...
	dumpTarget.appendChild(wordsDiv);
	wordsDiv.style ="overflow-y : scroll; height:430px; width: 800px";
	var legendBigDiv = document.getElementById("legendBigDiv");
	$(legendBigDiv).show();
